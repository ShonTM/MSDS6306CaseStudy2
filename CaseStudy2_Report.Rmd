...
predict(cdss.rf, c)
  ...
  labels <- data.frame(crimedata$householdsize, crimedata$ViolentCrimesPerPop, crimedata$medIncome, crimedata$agePct12t29, crimedata$blackPerCap,crimedata$HispPerCap, crimedata$RentLowQ, crimedata$PctLess9thGrade)
  randomForest(crimedata, labels)
