...
```{r}
#Check for normality
qqnorm(cdss$crimedata.ViolentCrimesPerPop, pch = 1, frame = FALSE, ylab ="Violent Crime Per Pop", xlab = "Spread of datapoints", main= "Violent Crime Per Pop Data", col="red") ## plots the data
qqline(cdss$crimedata.ViolentCrimesPerPop, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.medIncome, pch = 1, frame = FALSE, ylab ="Median HH Income", xlab = "Spread of datapoints", main= "Median Income Data", col= "Blue") ## plots the data
qqline(cdss$crimedata.medIncome, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.agePct12t29, pch = 1, frame = FALSE, ylab ="Age % between 12 to 29 yrs old", xlab = "Spread of datapoints", main= "Age % 12 - 29 yrs old Data", col="Orange") ## plots the data
qqline(cdss$crimedata.agePct12t29, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.blackPerCap, pch = 1, frame = FALSE, ylab ="Black Per Capita", xlab = "Spread of datapoints", main= "Black Per Capita data", col="green") ## plots the data
qqline(cdss$crimedata.blackPerCap, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.HispPerCap, pch = 1, frame = FALSE, ylab ="Hispanic per Capita", xlab = "Spread of datapoints", main= "Hispanic Per Capita data", col= "red") ## plots the data
qqline(cdss$crimedata.HispPerCap, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.RentLowQ, pch = 1, frame = FALSE, ylab ="Rent Low by Quartile", xlab = "Spread of datapoints", main= "Low Rent Q data", col= "darkgreen") ## plots the data
qqline(cdss$crimedata.RentLowQ, col = "steelblue", lwd = 2) ## adds a line

qqnorm(cdss$crimedata.PctLess9thGrade, pch = 1, frame = FALSE, ylab ="% Less than 9th Grad Education ", xlab = "Spread of datapoints", main= "% Less then 9th Grade Education data", col="brown") ## plots the data
